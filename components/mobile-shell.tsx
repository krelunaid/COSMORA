...
export function MobileShell({
  ...
  return (
    <main className="min-h-dvh bg-[#04050d] text-white">
      <div
        className={`mx-auto min-h-dvh w-full max-w-[430px] overflow-hidden border-white/10 bg-[#080918] sm:my-3 sm:min-h-[calc(100dvh-1.5rem)] sm:rounded-[34px] sm:border ${className}`}
      >
        {children}
      </div>
    </main>
