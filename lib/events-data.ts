...
const eventCatalog: EuropeEvent[] = [
  ...
  { name:'AnimagiC', city:'Mannheim', country:'Germany', flag:'🇩🇪', start:'2026-07-31', end:'2026-08-02', dateLabel:'31 JUL–2 AUG 2026', type:'Anime', url:'https://animagic.de/', image:'/cosmora-hero.jpg' },
  ...
  { name:'Lucca Comics & Games', city:'Lucca', country:'Italy', flag:'🇮🇹', start:'2026-10-28', end:'2026-11-01', dateLabel:'28 OCT–1 NOV 2026', type:'Pop Culture', url:'https://www.luccacomicsandgames.com/', image:'/cosmora-hero.jpg', featured:true, internalUrl:'/events/lucca-comics-2026' },
